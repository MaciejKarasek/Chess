...
main.o: src/main.cpp
	g++-10 -c ${COMPILER_FLAG} src/main.cpp

game.o: src/lib/game.cpp src/lib/game.hpp
	g++-10 -c ${COMPILER_FLAG} src/lib/game.cpp
	
Board.o: src/lib/Board.cpp src/lib/Board.hpp
	g++-10 -c ${COMPILER_FLAG} src/lib/Board.cpp

Field.o: src/lib/Field.cpp src/lib/Field.hpp
	g++-10 -c ${COMPILER_FLAG} src/lib/Field.cpp

Piece.o: src/lib/Piece.cpp src/lib/Piece.hpp
	g++-10 -c ${COMPILER_FLAG} src/lib/Piece.cpp
